...
contract CashManagerV2 is OwnableUpgradeable,
                          UUPSUpgradeable,
                          ICashManager,
                          PausableUpgradeable,
    ...
    uint256 public newBlockEveryNMicroseconds;
    ...
    uint256 public constant ONE_HUNDRED_PERCENT = 100 * (10**18);
    ...
    function initialize() external virtual initializer {
        ...
        newBlockEveryNMicroseconds = 4000;
        totalUSDValue = 0;
    ...
    function thisIsANewFunction() public returns (uint256) {
        newBlockEveryNMicroseconds = 5000;
        return 42;
    }

    function newFunctionThatEmits() public {
        uint256 newValue = thisIsANewFunction();
    ...
    // FIXME: This is an updated function
